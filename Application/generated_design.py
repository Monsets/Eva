...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ToggleSlider_TextNotify.setStyleSheet("border-radius: 5px;")
        ...
        self.settings_interface_page_layout.addWidget(self.label_7)
        self.horizontalSlider = QtWidgets.QSlider(self.settings_interface_page)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.settings_interface_page_layout.addWidget(self.horizontalSlider)
